...
const cardsData = [
    { imageUrl: 'w1.jpg', textContent: '<h2>$28</h2><p>White Curtains</p>' },
    { imageUrl: 'w2.jpg', textContent: '<h2>$7</h2><p>Laundry Bag</p>' },
    { imageUrl: 'w3.jpg', textContent: '<h2>$5-10 per Piece</h2><p>Decorative Plants</p>' },
    { imageUrl: 'w4.jpg', textContent: '<h2>$20</h2><p>Rounded Mirror </p>' },
    { imageUrl: 'w5.jpg', textContent: '<h2>$30</h2><p>Blender</p>' }
];
