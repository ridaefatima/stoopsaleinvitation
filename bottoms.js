...
const cardsData = [
    { imageUrl: 'b1.jpg', textContent: '<h2>$17</h2><p>Off-white Loose Trousers</p>' },
    { imageUrl: 'b2.jpg', textContent: '<h2>$13</h2><p>Long High-waisted Pink Skirt</p>' },
    { imageUrl: 'b3.jpg', textContent: '<h2>$23</h2><p>Camoflauge Cargo Pants</p>' },
    { imageUrl: 'b4.jpg', textContent: '<h2>$12</h2><p> Ripped Skinny Jeans </p>' },
    { imageUrl: 'b5.jpg', textContent: '<h2>$10</h2><p>Ladies Plaided Pyjamas</p>' }
];
